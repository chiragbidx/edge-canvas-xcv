...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your MailNest account",
        description: "Start sending beautiful emails in minutes.",
      };
    }
    return {
      id: "signin",
      title: "Sign in to MailNest",
      description: "Enter your email and password to access your campaigns.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Effortless Email Marketing for Teams and Businesses
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Build stunning email campaigns, manage subscribers, and analyze your results—all from the intuitive MailNest dashboard.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-secondary/70 bg-background/80 p-3 shadow-lg">
              <Image
                ...
                alt="MailNest dashboard preview"
        ...
        <div className="flex min-h-[720px] items-center justify-center p-4 sm:p-8 lg:p-10">
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <CardContent className="space-y-6">
              ...
              {mode === "signin" ? (
                <div className="text-center mt-2 space-y-1 text-muted-foreground text-sm">
                  Don&apos;t have an account?{" "}
                  <button
                    type="button"
                    className="font-semibold hover:underline text-primary ml-1"
                    onClick={() => setModeWithHash("signup")}
                  >
                    Get started free
                  </button>
